...
public final class ScanYieldVisitor implements VoidVisitor<Object> {
    ...
    public void visit(MethodCallExpr n, Object arg) {
        ...
        {
        	String methodName = n.getOriginalName();

	        if(YieldStore.getBlocks(methodName) == null)
	        {
	        	YieldStore.putBlock(methodName, new HashMap<String,BlockStmt>());
	        	YieldStore.getBlocks(methodName).put(methodName, n.getYieldBlock());
	        } else {
	        	YieldStore.getBlocks(methodName).put(n.getName(), n.getYieldBlock());
	        } 
        }
    }
    ...
    public void visit(MethodDeclaration n, Object arg) {
        ...
        visitTypeParameters(n.getTypeParameters(), arg);
        if (n.getParameters() != null) {
            YieldStore.putParams(n.getName(), n.getParameters());
        }
