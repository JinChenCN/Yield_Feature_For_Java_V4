...
//				}
	...
	public void visit(ConstructorDeclaration n, Object arg) {
		...
		if (returnSymbol instanceof Type) {
			...
			throw new A2SemanticsException(n.getName() + " is not a valid type on line " + n.getBeginLine());
		}
	...
	public void visit(MethodDeclaration n, Object arg) {
		...
		if(returnType == null)
		{
			throw new A2SemanticsException("Type " + n.getType().toString() + " is not defined on line " + n.getBeginLine());
		}
			...
			} catch (A2SemanticsException e)
		{
			...
			if (n.getParameters() != null) {
				for (Iterator<Parameter> i = n.getParameters().iterator(); i.hasNext();) {
					Parameter p = i.next();
					p.accept(this, arg);
					params.add(currentScope.resolveType(p.getType().toString()));
				}								
			} 		
			currentScope.getEnclosingScope().defineMethod(methodSymbol, params);	
		}
		...
		if (n.getParameters() != null) {
			...
			methodSymbol.putOverloadParams(parameters);			
		} 		
