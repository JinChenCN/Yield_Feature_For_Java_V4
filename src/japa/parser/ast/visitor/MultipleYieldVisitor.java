...
public final class MultipleYieldVisitor implements VoidVisitor<Object> {
    ...
    private void visitMemberAnnotations(List<AnnotationExpr> annotations, Object arg) {
        if (annotations != null) {
    ...
    public void visit(MethodDeclaration n, Object arg) {
    	...
    	HashMap<String, BlockStmt> yieldMap = YieldStore.getBlocks(name);
    	ArrayList<MethodDeclaration> methods = new ArrayList<MethodDeclaration>();
    	if( yieldMap != null)
    	{
    		for (int i = 1; i < yieldMap.size(); i++)
    		{  	
    			String newName = name+"Yield"+i;

    			MethodDeclaration m = new MethodDeclaration(n.getBeginLine(), n.getBeginColumn(), n.getJavaDoc(), 
    					n.getModifiers(), n.getAnnotations(), n.getTypeParameters(), 
    					n.getType(), newName, n.getParameters(), n.getArrayCount(), 
    					n.getThrows(), n.getBody());
    			methods.add(m);
    		}
    		YieldStore.putYieldMethods(name, methods);
    	} 
        ...
        if (n.getThrows() != null) {
            ...
            for (Iterator<NameExpr> i = n.getThrows().iterator(); i.hasNext();) {
                NameExpr nameExp = i.next();
                nameExp.accept(this, arg);
            }
        }
        if (n.getBody() == null) {
