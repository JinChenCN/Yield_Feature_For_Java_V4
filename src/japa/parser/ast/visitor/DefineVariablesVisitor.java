...
public class DefineVariablesVisitor implements VoidVisitor<Object> {
	...
	public void visit(FieldDeclaration n, Object arg) {
		...
		for (VariableDeclarator v : n.getVariables()) {
			Symbol typeSym = currentScope.resolve(n.getType().toString());			
			if(typeSym == null)
			{
				throw new A2SemanticsException(n.getType()
						+ " is not defined on line " + n.getType().getBeginLine());
			}
			Type type = null;
			if (typeSym instanceof Type) {
				type = (Type) typeSym;
			} else {
				throw new A2SemanticsException(typeSym.getName()
						+ " is not a valid type on line " + n.getType().getBeginLine());
			}

			String name = v.getId().toString();
			VariableSymbol symbol = new VariableSymbol(name, type);
			symbol.setDefinedLine(v.getBeginLine());
			symbol.setDefinedColumn(v.getBeginColumn());
	...
	public void visit(MethodDeclaration n, Object arg) {
		...
		if (currentScope instanceof MethodSymbol) {
			...
			throw new A2SemanticsException(currentScope.getClass().getName() + " is not a valid method on line " + n.getBeginLine());
		}
	...
	public void visit(VariableDeclarationExpr n, Object arg) {
		...
		for (VariableDeclarator v : n.getVars()) {
			...
			if (typeSym == null)
			{
				throw new A2SemanticsException(n.getType() + " is not defined on line " + n.getBeginLine());
			}

			if (typeSym instanceof Type) {
				type = (Type) typeSym;
			} else {
				throw new A2SemanticsException(typeSym.getName() + " is not a valid type on line " + n.getBeginLine());
			}
